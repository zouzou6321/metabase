...
import {
	...
	suggestCountDistinctOfEntityKeys
} from "metabase/lib/recommenders/table_based/common_aggregations";

export var TableBasedRecommenders = [
	{recommender: suggestUnderlyingData, base_weight: 100},
